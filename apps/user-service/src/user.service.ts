...
export class UserService {
  ...
  async register(registerPayload: RegisterDto): Promise<{ id: string; email: string; username: string }> {
  ...
  async updateUser(id: string, updateData: Partial<{ email: string; username: string }>) {
